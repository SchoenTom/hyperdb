...
**[VALIDITY](docs/VALIDITY.md)** and **[IDENTITY](docs/IDENTITY.md)**.
...
| **Availability-lagged factors** + COVID anchor test | the one-month misalignment bug | — |
...
Full register: **[docs/VALIDITY.md](docs/VALIDITY.md)**.
...
## Documentation — the red thread

| # | Doc | Purpose |
|---|---|---|
| 1 | [DESIGN.md](docs/DESIGN.md) | How the pipeline is built, layer by layer |
| 2 | [VALIDITY.md](docs/VALIDITY.md) | Every way the work could be devalued — and the countermeasure |
| 3 | [IDENTITY.md](docs/IDENTITY.md) | The PERMNO problem and how identity is resolved |
| 4 | [REPRODUCE.md](docs/REPRODUCE.md) | Rebuild it yourself + the acceptance criteria a "good" build must pass |

The build itself generates the empirical reports (cleaning impact, coverage, validation
results). They are not committed here — they do not exist until you run the pipeline.
...
`src/core/db.py`; see [DESIGN.md](docs/DESIGN.md).
